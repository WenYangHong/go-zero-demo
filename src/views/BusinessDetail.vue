...
const business = ref({
  ...
  title: '林志远的民宿',
  badge: '已验证 · 超赞房东 · 5年经营经验',
  hostName: '林志远',
  hostJoinInfo: '2019年加入平台 · 已帮助500+位房客',
  rating: 4.95,
  replyRate: '100%',
  hostDescription: '大家好，我是林志远，土生土长的浙江人。因为热爱山野和星空，放弃了城里的工作，在云顶山经营民宿已有5年。我喜欢亲手打造每一间房间，让它们既有山野的质朴，又有家的温馨。希望每一位来到这里的客人，都能放下疲惫，感受大自然的美好。',
  shopIntro: '我家共有3栋独立民宿，分别是：',
  certifications: [
  ...
  scoreOverview: [
    { label: '整体评分', value: 4.9, icon: markRaw(StarFilled), iconColor: 'text-warning' },
