...
type UserHomestayOrderListView struct {
	...
	HomestayId      int64   `json:"homestay_id"`       //民宿id
	Cover           string  `json:"cover"`             //封面
	OrderTotalPrice float64 `json:"order_total_price"` //订单总价格
	CreateTime      int64   `json:"create_time"`       //下单时间
	TradeState      int64   `json:"trade_state"`       //-1: 已取消 0:待支付 1:未使用 2:已使用  3:已退款 4:已过期
	LiveStartDate   int64   `json:"live_start_date"`   //入驻开始日期
	LiveEndDate     int64   `json:"live_end_date"`     //入驻结束日期
