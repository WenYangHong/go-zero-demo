...
(
    ...
    `tag`                   varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   NOT NULL DEFAULT '' COMMENT '标签（目前只允许一个）',
    `banner`                varchar(4096) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '轮播图，第一张封面',
    `img_info`              text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '轮播图,使用json格式存储',
...
(
    ...
    `avg_star`         decimal(10, 1)                                               NOT NULL COMMENT '星星数,多个维度',
    `cleanliness_star` decimal(10, 1)                                               NOT NULL COMMENT '清洁度评价',
    `location_star`    decimal(10, 1)                                               NOT NULL COMMENT '地理位置',
    `service_star`     decimal(10, 1)                                               NOT NULL COMMENT '服务态度',
    `value_star`       decimal(10, 1)                                               NOT NULL COMMENT '性价比',
    `version`          bigint                                                       NOT NULL DEFAULT '0' COMMENT '版本号',
    PRIMARY KEY (`id`)
