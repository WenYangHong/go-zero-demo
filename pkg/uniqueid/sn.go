...
const (
	SN_PREFIX_HOMESTAY_ORDER SnPrefix = "HSO" // 民宿订单前缀 homestay_order/homestay_order
	SN_PREFIX_THIRD_PAYMENT  SnPrefix = "PMT" // 第三方支付流水记录前缀 homestay_payment/third_payment
)
