...
func (c *usercenterClient) CreateNewUser(ctx context.Context, in *CreateNewUserReq, opts ...grpc.CallOption) (*CommonResp, error) {
	out := new(CommonResp)
	err := c.cc.Invoke(ctx, "/pb.usercenter/CreateNewUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Usercenter_CreateNewUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateNewUserReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UsercenterServer).CreateNewUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.usercenter/CreateNewUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsercenterServer).CreateNewUser(ctx, req.(*CreateNewUserReq))
	}
	return interceptor(ctx, in, info, handler)
}
